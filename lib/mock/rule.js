    ...
    * beforeSendResponse(requestDetail, responseDetail) {
        return new Promise((resolve, reject) => {
            ...
            if(requestDetail.url.indexOf('ws_console=true') > -1) {
                ...
                const scriptStr = `<script src="//${myIp}:${webPort}/socket.io.js"></script><script src="//${myIp}:${webPort}/ws_console.js"></script>`;
                const moScript =  `<script src="//${myIp}:${webPort}/mo_console.js"></script>`
                $('head').prepend(moScript);
