    ...
    * beforeSendResponse(requestDetail, responseDetail) {
        return new Promise((resolve, reject) => {
            ...
            if(requestDetail.url.indexOf('ws_console=true') > -1) {
                ...
                $ = cheerio.load(str);
                const myIp = global.__momo.ip||ipLib.address(), webPort = global.__momo.webPort||8002, wsPort=global.__momo.wsPort;
                const scriptStr = `<script src="//${myIp}:${webPort}/ws_console.js" wsport="${wsPort}"></script>`;
